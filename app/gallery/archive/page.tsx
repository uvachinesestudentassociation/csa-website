...
function Archive2425() {
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="2024-2025">
        <AccordionTrigger className="text-xl font-bold">2024–2025</AccordionTrigger>
        <AccordionContent>
...
function Archive2324() {
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="2023-2024">
        <AccordionTrigger className="text-xl font-bold">2023–2024</AccordionTrigger>
        <AccordionContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {events.map((event, index) => (
              <a key={index} href={event.link} target="_blank" rel="noopener noreferrer" className="block">
...
function Archive2223() {
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="2022-2023">
        <AccordionTrigger className="text-xl font-bold">2022–2023</AccordionTrigger>
        <AccordionContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {events.map((event, index) => (
              <a key={index} href={event.link} target="_blank" rel="noopener noreferrer" className="block">
...
function Archive2122() {
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="2021-2022">
        <AccordionTrigger className="text-xl font-bold">2021–2022</AccordionTrigger>
        <AccordionContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {events.map((event, index) => (
              <a key={index} href={event.link} target="_blank" rel="noopener noreferrer" className="block">
